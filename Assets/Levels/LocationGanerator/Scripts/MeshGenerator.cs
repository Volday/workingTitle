...
public class MeshGenerator {
    ...
    public static MeshData GenerateTerrainMesh(float[,] heightMap, float heightMultiplier, AnimationCurve _heightCurve, int levelOfDitail, bool useFlatShading) {
        ...
        int vertexPerLine = (meshSize - 1) / meshSimplificationIncrement + 1;

        MeshData meshData = new MeshData(vertexPerLine, useFlatShading);
